# Based on https://github.com/Xilinx/brevitas/blob/master/src/brevitas_examples/bnn_pynq/models/resnet.py
...
# from .minifloat import fp_mixin_factory, mf_to_raw
...
class QuantBasicBlock(nn.Module):
    ...
    def __init__(
        self,
        in_planes,  # num input filters
        planes,  # num output filters
        stride=1,
        bias=False,
        shared_quant_act=None,
        act_bit_width=8,  # Assumes input is uint8
        weight_bit_width=8,
...
def quant_resnet18(weight_bit_width, act_bit_width, num_classes) -> QuantResNet:
    model = QuantResNet(
